...
if __name__ == "__main__":
    NODE_FEAT_CSV   = os.getenv("NODE_FEAT_CSV",   r"graphsage_iintervention_2\pheme_node_features_roberta.csv")
    REPLY_LEVEL_CSV = os.getenv("REPLY_LEVEL_CSV", r"graphsage_iintervention_2\pheme_reply_level_v3.csv")
