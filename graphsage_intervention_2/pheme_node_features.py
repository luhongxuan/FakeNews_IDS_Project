...
def main():
    ...
    reply_level_csv = r"graphsage_intervention_2\pheme_reply_level_v3_advance.csv"
    pheme_path = r"data\raw\pheme"
    output_csv = r"graphsage_intervention_2\pheme_node_features_roberta.csv"

    print(f"讀取 {reply_level_csv} ...")
    ...
    user_feats = build_user_feature_table(pheme_path)
    ...
    print(f"\n已寫入: {output_csv}（{len(node_df)} 列，{len(node_df.columns)} 欄）")
